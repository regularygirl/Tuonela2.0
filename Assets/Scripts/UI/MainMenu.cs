...
public class MainMenu : MonoBehaviour
{
    ...
    [SerializeField] GameObject runSelectPlayerType;
    ...
    {
        runSelectPlayerType.SetActive(false);
        mainMenu.SetActive(true);
    }
    public void SelectPlayerTypeAndStartGame(string type)
    {
        Globals.playerType = type;
        runSelectPlayerType.gameObject.SetActive(false);
        runLengthPopup.gameObject.SetActive(true);
    }

    public void EnablePopupForPlayerType()
    {
        runSelectPlayerType.gameObject.SetActive(true);
